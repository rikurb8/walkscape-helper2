---
title: "Create a copper bar (Scrap)"
source_url: "https://wiki.walkscape.app/wiki/Copper_bar"
source_oldid: 27001
scraped_at: "2026-02-20T17:15:16.262Z"
categories:
...
The **Copper bar** [item](https://wiki.walkscape.app/wiki/Special:MyLanguage/Items "Special:MyLanguage/Items") is a [material](https://wiki.walkscape.app/wiki/Special:MyLanguage/Materials "Special:MyLanguage/Materials").

# Uses

## Recipe Ingredient

Copper bar is an ingredient in the following [recipes](../index.md):

## Job Boards

Copper bar can be requested from the following [job](https://wiki.walkscape.app/wiki/Special:MyLanguage/Job_Boards "Special:MyLanguage/Job Boards"):
...
> With the right techniques, you're smelting copper into a durable metal bar, crafting a copper bar.

Heat and shape copper into a solid bar for various uses.

### Create a copper bar (Scrap)

> With the right techniques, you're smelting metal scraps into a durable copper bar.

Heat and shape metal scrap into a solid bar for various uses.
...
No guides exists yet. [You can help make one.](https://wiki.walkscape.app/index.php?title=Guide:Copper_bar&action=edit)

# Gear Sets

No gear sets exist yet. [You can help make one.](https://wiki.walkscape.app/index.php?title=Gear:Copper_bar&action=edit)
