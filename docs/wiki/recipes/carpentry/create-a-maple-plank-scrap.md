---
title: "Create a maple plank (Scrap)"
source_url: "https://wiki.walkscape.app/wiki/Maple_plank"
source_oldid: 27015
scraped_at: "2026-02-20T17:13:55.121Z"
categories:
...
The **Maple plank** [item](https://wiki.walkscape.app/wiki/Special:MyLanguage/Items "Special:MyLanguage/Items") is a [material](https://wiki.walkscape.app/wiki/Special:MyLanguage/Materials "Special:MyLanguage/Materials").

# Uses

## Recipe Ingredient

Maple plank is an ingredient in the following [recipes](../index.md):

## Job Boards

Maple plank can be requested from the following [jobs](https://wiki.walkscape.app/wiki/Special:MyLanguage/Job_Boards "Special:MyLanguage/Job Boards"):
...
> Meticulously crafting maple wood into a smooth plank, you're crafting a maple plank.

Shape maple wood into a smooth and elegant plank.

### Create a maple plank (Scrap)

> Meticulously crafting wood scraps into a smooth plank, you're crafting a maple plank.

Shape scraps into a smooth and elegant plank.
...
No guides exists yet. [You can help make one.](https://wiki.walkscape.app/index.php?title=Guide:Maple_plank&action=edit)

# Gear Sets

No gear sets exist yet. [You can help make one.](https://wiki.walkscape.app/index.php?title=Gear:Maple_plank&action=edit)
