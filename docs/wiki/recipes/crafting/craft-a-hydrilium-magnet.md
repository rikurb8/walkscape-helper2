---
title: "Craft a hydrilium magnet"
source_url: "https://wiki.walkscape.app/wiki/Hydrilium_magnet"
source_oldid: 27490
scraped_at: "2026-02-20T17:15:06.682Z"
categories:
  - "Pages_using_Tabber_parser_tag"
  - "Normal_Items"
  - "Crafted_Items"
  - "Tools_Slot_Items"
  - "Magnetic_Keyword_Items"
  - "Good_Items"
  - "Great_Items"
  - "Excellent_Items"
  - "Perfect_Items"
  ...
  - "Equipment_With_Bonus_Experience_While_Mining_Attribute"
  - "Equipment_With_Double_Action_While_Mining_Attribute"
  - "Equipment_With_Steps_Required_While_Mining_Attribute"
...
> A miner's magnet infused with hydrilium.

The **Hydrilium magnet** [item](https://wiki.walkscape.app/wiki/Special:MyLanguage/Items "Special:MyLanguage/Items") is a [crafted item](https://wiki.walkscape.app/wiki/Special:MyLanguage/Crafted "Special:MyLanguage/Crafted").
...
> With focused intent, you improve the magnet with hydrilium, hoping to create a tool with the power to unlock the secrets of the subterranean realm.

Improve a magnetic tool that will effortlessly draw forth the riches hidden deep within the earth.

#### Crafting Flow

# Guides

No guides exists yet. [You can help make one.](https://wiki.walkscape.app/index.php?title=Guide:Hydrilium_magnet&action=edit)
